...
preds <- purrr::map(files, ~process_preds(.x, aoi = aoi, resolution = 500, distance = TRUE, save = FALSE))
...
# read in rasters
maps <- purrr::map(list.files("data/output_sdm/", pattern = ".tif", full.names = TRUE), terra::rast)
