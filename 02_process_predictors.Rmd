...
```{r}
is <- rast("data/input_raw/Jasmine/Jasmine_lancover_sep/lc_Imperv_Roads.tif")

isr <-  rast("data/input_raw/Jasmine/Jasmine_lancover_sep/lc_Imperv_Roads.tif")

is_all <- terra::merge(is, isr)

writeRaster(is_all, "data/input_raw/Jasmine/Jasmine_lancover_sep/lc_Imperv_all.tif")
```
...
path_perccov <- c(
  # jasmine layers
  "data/input_raw/Jasmine/Jasmine_lancover_sep/lc_Imperv_all.tif",
