...
path_dist <- c("data/input_raw/Buildings/Buildings.shp",
              ...
              "data/input_raw/NTAD_North_American_Roads_-6941702301048783378/North_American_Roads.shp",
              "data/input_raw/Street_Centerlines/Street_Centerlines.shp")
path_nodist <- c("data/input_raw/Buildings/Buildings.shp",
              "data/input_raw/Green_Space/nic_green_space_2015.shp",
              "data/input_raw/Hydrology/Hydrology.shp",
              "data/input_raw/Impervious_Surface/impervious_surfaces_fort_collins_2015.shp",
              "data/input_raw/Natural_Habitat/bc8f7f07-7560-4191-aa2e-8f274a1c29e7202046-1-133oxp5.v8wfi.shp",
...
pred_dist <- purrr::map(path_dist, process_preds, template, resolution, distance=TRUE, save=FALSE, output_path) %>%
  set_names(tools::file_path_sans_ext(basename(path_dist)))

# process non distance predictors
pred_nodist <- purrr::map(path_nodist, process_preds, template, resolution, distance=FALSE, save=FALSE, output_path) %>% set_names(tools::file_path_sans_ext(basename(path_nodist)))
```
