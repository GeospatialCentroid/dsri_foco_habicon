...
final_output <- list(
  ...
  response_curves = plot(selected_mod, type = "cloglog"),
...
To do - Need to find a way to calculate variable importance and response curve plots

<https://rdrr.io/github/mrmaxent/maxnet/src/R/response.plot.R>
...
m[, v] <- if (!is.null(levels)) levels else seq(min - 0.1 * (max - min), max + 0.1 * (max - min), length = 100)
