...
path_nodist <- c()
path_dist <- c("data/input_raw/landcover_mchale/FC_landcover_sep/lc_TreeCanopy.tif",
...
```{r}
# stack rasters
combined_rast <- terra::rast(pred_dist)

# Save the predictor raster stack
writeRaster(combined_rast, filename = file.path(output_path, "greenspace_stack_dist.tif"), overwrite = TRUE)
```
